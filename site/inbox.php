...
<body>
    ...
    <div id="main">
        <div id="searchbar" class="row col-sm-12">
            <label for="to" class="col-sm-1" style="display:none;">Receiver:</label>
            <div class="col-sm-3 form-group" style="display:none;">
                <input class="form-control" id="to" name="to" type="text"/>
            </div>
            <label for="from" class="col-sm-1">Sender:</label>
                ...
                success: function(result) {
                    ...
                    for (let i = 0; i < Object.keys(results).length; i++) {
                        ...
                        text += "'>"+
                            ...
                            "</div>";
                            text += "<div class='col-sm-12'>"+results[key]["body"]+"</div>"+
                        "</li>";
